...
during prediction tasks on a graph. It uses notions of edge curvature to measure the quality
of the rewiring. The method is tested on a variety of graph datasets and compared
to other ones by the authors. We have reproduced some experiments with slightly
lesser results. Ultimately, we have gotten better accuracy results with 
the Cayley Graph Propagation method proposed by \cite{wilson2024cayleygraphpropagation}.
